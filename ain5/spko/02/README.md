...
## 1. Vorbereitung und Lexer-Implementierung
...
## 2. Handhabung der Case-Insensitivity in VHDL
...
## 4. Auflösung von Ausdrücken (Expressions) und Operator-Prioritäten
